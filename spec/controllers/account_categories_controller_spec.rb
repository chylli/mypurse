...
RSpec.describe AccountCategoriesController, :type => :controller do
  ...
  describe "GET show" do
    it "assigns the requested account_category as @account_category" do
      ...
      expect(assigns(:account_category)).to eq(account_category)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new account_category as @account_category" do
      ...
      expect(assigns(:account_category)).to be_a_new(AccountCategory)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new AccountCategory" do
        ...
        }.to change(AccountCategory, :count).by(12)
      end

      it "assigns a newly created account_category as @account_category" do
        post :create, {:account_category => valid_attributes2}, valid_session
        expect(assigns(:account_category)).to be_a(AccountCategory)
        expect(assigns(:account_category)).to be_persisted
        expect(assigns(:account_category).user_id).to eq(user.id)
      end

      it "redirects to the created account_category" do
        post :create, {:account_category => valid_attributes2}, valid_session
        expect(response).to redirect_to(AccountCategory.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved account_category as @account_category" do
        post :create, {:account_category => invalid_attributes}, valid_session
        expect(assigns(:account_category)).to be_a_new(AccountCategory)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested account_category" do
        account_category = AccountCategory.create! valid_attributes
        put :update, {:id => account_category.to_param, :account_category => new_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns the account_category as @account_category" do
        account_category = AccountCategory.create! valid_attributes
        put :update, {:id => account_category.to_param, :account_category => invalid_attributes}, valid_session
        expect(assigns(:account_category)).to eq(account_category)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the account_categories list" do
      account_category = AccountCategory.create! valid_attributes
      delete :destroy, {:id => account_category.to_param}, valid_session
      expect(response).to redirect_to(account_categories_url)
    end
  end
