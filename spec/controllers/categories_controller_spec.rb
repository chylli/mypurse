  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested category" do
        account_category = Category.create! valid_attributes
        put :update, {:id => account_category.to_param, :category => new_attributes}, valid_session
      ...
      it "assigns the requested category as @category" do
        account_category = Category.create! valid_attributes
        put :update, {:id => account_category.to_param, :category => valid_attributes}, valid_session
        expect(assigns(:category)).to eq(account_category)
      end
    ...
    describe "with invalid params" do
      it "assigns the category as @category" do
        account_category = Category.create! valid_attributes
        put :update, {:id => account_category.to_param, :category => invalid_attributes}, valid_session
        expect(assigns(:category)).to eq(account_category)
      end
