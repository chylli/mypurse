...
RSpec.describe AccountTypesController, :type => :controller do
  ...
  # It is used to create an AccountType directly
  let(:valid_attributes) {
    {user_id: user.id, name: "type", description: "account type"}
  }

  # This is used to post to create an AccountType
  let(:valid_attributes2) {
    {name: "type", description: "account type"}
  }

  let(:invalid_attributes) {
    { name: "x" * 35, description: "account type"}
  }
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new AccountType" do
        expect {
          post :create, {:account_type => valid_attributes2}, valid_session
      ...
      it "assigns a newly created account_type as @account_type" do
        ...
        expect(assigns(:account_type).user_id).to eq(user.id)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested account_type" do
        ...
        account_type.reload
        expect(account_type.name).to eq("name2")
      end
